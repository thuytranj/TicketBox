...
#### Scenario: Gửi thông báo real-time khi hoàn thành/thất bại import
- **WHEN** Tiến trình xử lý import file CSV hoàn tất thành công hoặc gặp lỗi thất bại hoàn toàn
- **THEN** Hệ thống thông qua giao thức WebSocket (Socket.io) gửi thông báo cập nhật trạng thái chi tiết của Job import đến tài khoản ban tổ chức (`userId`) đã yêu cầu import.
