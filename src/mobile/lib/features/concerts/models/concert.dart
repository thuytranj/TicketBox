...
class Concert {
  ...
  ConcertGateState get gateState {
    ...
    if (localStart != null && now.isBefore(localStart)) {
  ...
  String get gateEyebrowLabel => switch (gateState) {
  ...
  String get gateBlockedMessage => switch (gateState) {
  ...
  String get gateStatusLine => switch (gateState) {
