    ...
    const concertsData = [
      {
        ...
        summary: 'Đêm nhạc tái hiện các kỷ nguyên âm nhạc độc đáo của siêu sao thế giới Taylor Swift.',
      ...
      },
      {
        ...
        summary: 'Bão Rock trở lại Hà Nội hứa hẹn một đêm cháy hết mình của các tín đồ nhạc Rock.',
      ...
      },
      {
        ...
        summary: ' BLACKPINK quay trở lại Mỹ Đình trong tour diễn Born Pink hoành tráng nhất lịch sử.',
      ...
      },
      {
        ...
        summary: 'Đêm nhạc mộc mạc bên bờ sóng của các nghệ sĩ Indie được yêu thích nhất.',
      ...
      },
      {
        ...
        summary: 'Sự kết hợp hoàn hảo giữa âm thanh thính phòng bác học và ánh sáng 3D mapping.',
      ...
      },
      {
        ...
        summary: 'Đêm nhạc bùng nổ năng lượng của các thế hệ Rapper đình đám Việt Nam.',
      ...
      },
      {
        ...
        summary: 'Thưởng thức nhạc Jazz sâu lắng trong không khí se lạnh của xứ sở ngàn hoa.',
      ...
      },
      {
        ...
        posterUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=800',
        summary: 'Nhảy múa cùng các DJ quốc tế và Việt Nam trong đại tiệc EDM hoành tráng.',
      ...
      },
      {
        ...
        location: 'Công viên Biển Đông, Đà Nẵng',
        posterUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800',
        summary: 'Live concert kết hợp giữa âm nhạc lãng mạn và không gian biển thơ mộng.',
      ...
      },
      {
        ...
        posterUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800',
        summary: 'Giai điệu hoài niệm trong không gian hoàng cung Huế xưa kính.',
      ...
      },
      {
        ...
        posterUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=800',
        summary: 'Lễ hội âm nhạc điện tử kết hợp ẩm thực sông nước Cần Thơ.',
