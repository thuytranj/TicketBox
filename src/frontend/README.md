...
Danh mục huy hiệu công nghệ cốt lõi của Frontend:
...
![Vitest](https://img.shields.io/badge/Vitest-303030?style=for-the-badge&logo=vitest&logoColor=FCC72B)
...
## 4. Quy trình Khởi chạy & Phát triển (Developer Workflow)
...
## 5. Tài khoản kiểm thử mặc định (Default Seed Accounts)
...
## 6. Quy tắc sử dụng Design System & CSS Tokens (Quy chuẩn code UI)
...
## 7. Quy trình Kiểm thử tự động (Testing Workflow)
